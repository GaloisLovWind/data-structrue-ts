...
export class DoubleLink<T> implements ILink<T> {
    ...
    public insert(index: number, e: T): void {
        ...
        if ( index === 0) {
            ...
            if (preNode.next !== null) {// 表明不是表尾，如果是表尾则 preNode.next = null;
    ...
    public remove(index: number): T {
        ...
        if (index === 0) {
            ...
            if (preNode.next !== null) {
                preNode.next.prev = preNode.prev; // 表明不是表尾，如果是表尾则 preNode.next = null;
            }
